...
export function useSignIn() {
  return Urql.useMutation<SignIn, SignInVariables>(SignInDocument);
};
...
export function useUpdateProfile() {
  return Urql.useMutation<UpdateProfile, UpdateProfileVariables>(UpdateProfileDocument);
};
...
export function useRequestWithdraw() {
  return Urql.useMutation<RequestWithdraw, RequestWithdrawVariables>(RequestWithdrawDocument);
};
...
export function useSwap() {
  return Urql.useMutation<Swap, SwapVariables>(SwapDocument);
};
...
export function useCreateArtwork() {
  return Urql.useMutation<CreateArtwork, CreateArtworkVariables>(CreateArtworkDocument);
};
...
export function useDeleteArtwork() {
  return Urql.useMutation<DeleteArtwork, DeleteArtworkVariables>(DeleteArtworkDocument);
};
...
export function useMint() {
  return Urql.useMutation<Mint, MintVariables>(MintDocument);
};
...
export function useStartAuction() {
  return Urql.useMutation<StartAuction, StartAuctionVariables>(StartAuctionDocument);
};
...
export function useCloseAuction() {
  return Urql.useMutation<CloseAuction, CloseAuctionVariables>(CloseAuctionDocument);
};
...
export function useClaimToken() {
  return Urql.useMutation<ClaimToken, ClaimTokenVariables>(ClaimTokenDocument);
};
...
export function usePlaceBid() {
  return Urql.useMutation<PlaceBid, PlaceBidVariables>(PlaceBidDocument);
};
...
export function useGetProfile(options: Omit<Urql.UseQueryArgs<GetProfileVariables>, 'query'> = {}) {
  return Urql.useQuery<GetProfile>({ query: GetProfileDocument, ...options });
};
...
export function useGetNonce(options: Omit<Urql.UseQueryArgs<GetNonceVariables>, 'query'> = {}) {
  return Urql.useQuery<GetNonce>({ query: GetNonceDocument, ...options });
};
...
export function useGetDepositAddress(options: Omit<Urql.UseQueryArgs<GetDepositAddressVariables>, 'query'> = {}) {
  return Urql.useQuery<GetDepositAddress>({ query: GetDepositAddressDocument, ...options });
};
...
export function useGetInfo(options: Omit<Urql.UseQueryArgs<GetInfoVariables>, 'query'> = {}) {
  return Urql.useQuery<GetInfo>({ query: GetInfoDocument, ...options });
};
...
export function useGetKycToken(options: Omit<Urql.UseQueryArgs<GetKycTokenVariables>, 'query'> = {}) {
  return Urql.useQuery<GetKycToken>({ query: GetKycTokenDocument, ...options });
};
...
export function useGetArtwork(options: Omit<Urql.UseQueryArgs<GetArtworkVariables>, 'query'> = {}) {
  return Urql.useQuery<GetArtwork>({ query: GetArtworkDocument, ...options });
};
...
export function useGetIndexPage(options: Omit<Urql.UseQueryArgs<GetIndexPageVariables>, 'query'> = {}) {
  return Urql.useQuery<GetIndexPage>({ query: GetIndexPageDocument, ...options });
};
...
export function useCreatorsIndex(options: Omit<Urql.UseQueryArgs<CreatorsIndexVariables>, 'query'> = {}) {
  return Urql.useQuery<CreatorsIndex>({ query: CreatorsIndexDocument, ...options });
};
...
export function useArtworksIndex(options: Omit<Urql.UseQueryArgs<ArtworksIndexVariables>, 'query'> = {}) {
  return Urql.useQuery<ArtworksIndex>({ query: ArtworksIndexDocument, ...options });
};